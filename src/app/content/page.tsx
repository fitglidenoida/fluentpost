...
export default function ContentStudio() {
  const { content, isLoading, error, fetchBlogPosts, fetchTopics, createBlogPost } = useAppStore()
  ...
  const generateBlogContent = async () => {
    const prompt = {
      type: 'blog' as const,
      topic: newBlogPost.title || 'fitness and wellness',
      tone: 'enthusiastic',
      length: 'medium'
    }
    ...
    // The result will contain instructions for manual GPT Plus processing
  }
      ...
      <div className="ml-64 p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 text-lg">Create and manage viral blog posts with AI assistance</p>
          </div>
              ...
              <form onSubmit={handleCreateBlogPost}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select 
                      value={newBlogPost.topicId}
                      onChange={(e) => setNewBlogPost({...newBlogPost, topicId: e.target.value})}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    >
                  ...
                  <div>
                    ...
                    <input 
                      type="text"
                      value={newBlogPost.metaKeywords}
                      onChange={(e) => setNewBlogPost({...newBlogPost, metaKeywords: e.target.value})}
