        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold">FluentPost</h3>
                <p className="text-gray-400 text-sm">Marketing Automation Platform</p>
              </div>
            </div>
            <p className="text-gray-400 mb-4">
              AI-powered marketing automation platform for social media management, 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:privacy@fluentpost.in" className="text-gray-400 hover:text-white transition-colors">
                  Contact Privacy
                </a>
              </li>
              <li>
                <a href="mailto:legal@fluentpost.in" className="text-gray-400 hover:text-white transition-colors">
                  Contact Legal
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 FluentPost. All rights reserved.
            </p>
